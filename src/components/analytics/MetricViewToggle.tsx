...
export function AverageTooltip({ count }: { count: number }) {
  return (
    <span className="group relative inline-flex items-center">
      <Info
        size={12}
        className="text-zinc-300 transition-colors group-hover:text-zinc-500"
        aria-hidden
      />
      <span className="sr-only">Average is calculated across the {count} selected properties.</span>
