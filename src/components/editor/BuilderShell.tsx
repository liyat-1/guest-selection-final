  ...
  if (needsLayout) {
    return (
      <div className="grid min-h-dvh place-items-center bg-zinc-900/70 p-4 font-sans text-zinc-900">
        <div className="w-full max-w-3xl border border-zinc-300 bg-white shadow-pop">
  ...
  return (
    ...
    >
      <div
        ...
        className={`flex min-h-0 flex-1 flex-col overflow-hidden bg-zinc-100 shadow-pop ${
      ...
      >
        ...
        <div className="relative flex min-h-0 flex-1 overflow-hidden">
          ...
          <aside
            className={`${
              panelOpen
                ? "absolute inset-y-0 left-0 z-40 flex w-[86vw] max-w-[22rem] shadow-pop"
                : "hidden"
      ...
      {saveOpen && (
        <div className="fixed inset-0 z-[95] grid place-items-center bg-zinc-900/50 p-4">
          <div
            ...
            className="w-full max-w-md border border-zinc-200 bg-white p-6 shadow-pop"
          >
      ...
      {savedTemplate && (
        <div className="fixed inset-0 z-[96] grid place-items-center bg-zinc-900/50 p-4">
          <div
            ...
            className="w-full max-w-sm border border-zinc-200 bg-white p-6 text-center shadow-pop"
          >
