...
export function EditorPanel({
  ...
  return (
    <aside
      aria-label={title}
      className="absolute inset-y-0 right-0 z-40 flex w-[min(92vw,26rem)] shrink-0 flex-col border-l border-zinc-200 bg-white shadow-pop shadow-zinc-900/10 lg:relative lg:w-[24rem] lg:shadow-none"
    >
