...
export function FloatingCard({
  ...
  return (
    <div
      ...
      role="dialog"
      aria-label={title}
      className="fixed z-[80] flex max-h-[min(70vh,34rem)] w-[20.5rem] flex-col overflow-hidden rounded-2xl border border-zinc-200 bg-white/95 shadow-pop shadow-zinc-900/25 backdrop-blur"
