...
const OTHERS = [
  {
    from: "Booking.com",
    subject: "Your trip to Athens is coming up",
    snippet: "Check-in details and directions",
    time: "8:12 AM",
  },
  {
    from: "Aegean Miles+Bonus",
    subject: "You earned 1,240 miles",
    snippet: "Statement for this month is ready",
    time: "Yesterday",
  },
      ...
      <div className="overflow-hidden rounded-xl border border-zinc-300 bg-white shadow-sm">
        ...
        >
          ...
          <span
            ...
            style={{ background: gmail ? "#1a73e8" : "#ffffff33" }}
          >
            L
          </span>
        </div>
        ...
        {opened ? (
          <div>
            <div className="flex items-center gap-1 border-b border-zinc-200 px-4 py-2 text-zinc-500">
              ...
              <Reply size={15} className="ml-2" />
              <Forward size={15} className="ml-2" />
              <MoreHorizontal size={15} className="ml-2" />
            </div>
            <div className="px-5 py-4">
              ...
              <div className="mt-3 grid grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="truncate text-[12px] text-zinc-500">to me · {preheader}</p>
                </div>
