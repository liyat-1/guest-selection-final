  ...
  return (
    ...
    >
      <span>
        ...
        {hint && (
          <span className="mt-0.5 block text-[11.5px] leading-snug text-zinc-500">{hint}</span>
        )}
      </span>
      <span
      ...
      <div className="flex items-center gap-3">
        <div className="h-16 w-24 shrink-0 overflow-hidden rounded-lg bg-zinc-100 ring-1 ring-black/10">
          {value ? (
            ...
            <div className="grid size-full place-items-center text-[10px] text-zinc-400">None</div>
          )}
        </div>
