...
export type JourneyStageId =
  "booking" | "welcome" | "prearrival" | "stay" | "poststay" | "winback" | "retention";
...
export const JOURNEY: JourneyStage[] = [
  {
    ...
    metrics: [
      ...
      { label: "Booking value", value: "$3.9M" },
      {
        ...
        value: "73%",
        hint: "Guests with a usable direct contact channel.",
      },
    ],
  },
  {
...
export const HEADLINE_KPIS: Kpi[] = [
  ...
  },
  {
    ...
    tooltip:
      "Revenue from direct bookings attributed to an OTA Buster touchpoint within the attribution window.",
  },
  {
...
export const FUNNEL: FunnelStage[] = [
  ...
  { id: "engaged", label: "Engaged guests", count: 5981, note: "Opened or replied at least once" },
  {
    ...
    count: 2140,
    note: "Repeat engagement or offer interest",
  },
  {
    id: "clicks",
    label: "Direct booking clicks",
    count: 1102,
    note: "Opened the direct booking offer",
  },
...
export const OFFER_TYPES: OfferType[] = [
  {
    ...
    category: "rate",
    costModel: "% of booking",
    estimatedCost: 50,
    description: "A straightforward rate cut on the direct rate.",
  },
  {
    id: "fixed",
    name: "Fixed discount",
    category: "rate",
    costModel: "Flat amount",
    estimatedCost: 40,
    description: "A fixed amount off the next direct stay.",
  },
  {
    id: "breakfast",
    name: "Free breakfast",
    category: "experience",
    costModel: "Cost of covers",
    estimatedCost: 25,
    description: "High perceived value, low marginal cost.",
  },
  {
    id: "upgrade",
    name: "Room upgrade",
    category: "experience",
    costModel: "Opportunity cost",
    estimatedCost: 30,
    description: "Best when the next tier is likely to be unsold.",
  },
  {
    id: "late",
    name: "Late checkout",
    category: "flexibility",
    costModel: "Housekeeping impact",
    estimatedCost: 8,
    description: "Almost free on low-occupancy days.",
  },
  {
    id: "early",
    name: "Early check-in",
    ...
    costModel: "Housekeeping impact",
    estimatedCost: 8,
    description: "Popular with business and long-haul travellers.",
  },
  {
    id: "parking",
    name: "Free parking",
    category: "amenity",
    costModel: "Space opportunity cost",
    estimatedCost: 18,
    description: "Strong in city properties with paid parking.",
  },
  {
    id: "amenity",
    ...
    costModel: "Item cost",
    estimatedCost: 12,
    description: "A small in-room gesture on arrival.",
  },
  {
    id: "experience",
    name: "Complimentary experience",
    category: "experience",
    costModel: "Partner cost",
    estimatedCost: 35,
    description: "Tour, tasting, or activity included.",
  },
  {
    id: "spa",
    name: "Spa credit",
    category: "experience",
    costModel: "Credit value",
    estimatedCost: 40,
    description: "Works well for leisure and couples.",
  },
  {
    id: "dining",
    name: "Dining credit",
    ...
    costModel: "Credit value",
    estimatedCost: 30,
    description: "Drives on-property spend as well as conversion.",
  },
  {
    id: "package",
    name: "Exclusive package",
    category: "custom",
    costModel: "Bundle cost",
    estimatedCost: 45,
    description: "A bundle guests cannot get on an OTA.",
  },
  {
    id: "bestrate",
    name: "Best-rate promise",
    category: "rate",
    costModel: "Rate parity risk",
    estimatedCost: 0,
    description: "No direct cost. Weaker pull on its own.",
  },
  {
    id: "none",
    name: "No incentive",
    ...
    costModel: "None",
    estimatedCost: 0,
    description: "Relationship only. Lowest conversion, highest margin.",
  },
];
...
export const SEGMENT_OFFERS = [
  {
    segment: "High-value guest",
    offer: "Room upgrade",
    basis: "Highest average booking value; upgrade cost is opportunity-only.",
  },
  {
    segment: "Family",
    offer: "Breakfast + late checkout",
    basis: "Two low-cost benefits that remove real travel friction.",
  },
  {
    segment: "Business traveller",
    offer: "Flexible checkout",
    basis: "Flexibility outperformed rate cuts in this segment.",
  },
  {
    segment: "Price-sensitive traveller",
    offer: "10% off",
    basis: "Rate is the deciding factor in this segment's click behaviour.",
  },
  {
    segment: "Luxury traveller",
    offer: "Complimentary experience",
    basis: "Experience offers outperform discounts on premium rates.",
  },
];
...
export const GUESTS: Guest[] = [
  {
    ...
    score: 82,
    scoreReasons: [
      "Opened every message",
      "5-star feedback",
      "Booking value above property average",
    ],
    nextBestAction:
      "Send the direct-booking offer now — feedback was positive and engagement is high.",
    actionTone: "convert",
  ...
  },
  {
    ...
    scoreReasons: [
      "5-star feedback",
      "Clicked the offer twice",
      "Approaching typical booking window",
    ],
  ...
  },
  {
    ...
    nextBestAction:
      "Move to retention — recognise the second stay and remember her room preference.",
    actionTone: "convert",
...
export const OPPORTUNITIES: Opportunity[] = [
  {
    ...
    reason:
      "They opened the direct-booking benefit in the last 10 days and returned to the page twice.",
  ...
  },
  {
    ...
    reason:
      "Their most recent reservation came through an OTA channel after booking direct before.",
