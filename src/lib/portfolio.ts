...
export const KPIS: KpiDef[] = [
  {
    key: "revenue",
    label: "Revenue",
    hint: "Booking revenue attributed to Directful",
    format: "currency",
    averageFormat: "currency",
  },
  {
    key: "directBookings",
    label: "Direct bookings",
    hint: "Bookings made on your own site",
    format: "number",
    averageFormat: "decimal",
  },
  {
    key: "subscribers",
    label: "Subscribers",
    hint: "Opted-in guest contacts",
    format: "number",
    averageFormat: "decimal",
  },
  {
    ...
    hint: "Unique guests messaged in range",
    format: "number",
    averageFormat: "decimal",
  },
  {
    key: "otaGuests",
    label: "OTA guests reached",
    hint: "Guests acquired via OTA and re-engaged",
    format: "number",
    averageFormat: "decimal",
  },
  {
  ...
  },
  {
    key: "clicks",
    label: "Clicks",
    hint: "Link clicks across all messages",
    format: "number",
    averageFormat: "decimal",
  },
  {
    key: "conversions",
    label: "Conversions",
    hint: "Messages that ended in a booking",
    format: "number",
    averageFormat: "decimal",
  },
  {
    ...
    hint: "New reviews attributed to campaigns",
    format: "number",
    averageFormat: "decimal",
  },
];
